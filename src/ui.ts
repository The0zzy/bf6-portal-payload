...
let enemybgcolour = mod.CreateVector(0.4, 0.2, 0.2);
...
export function uiSetup(): void {
    ...
    mod.AddUIContainer("progress1", mod.CreateVector(150, 0, 0), mod.CreateVector(200, 20, 0), mod.UIAnchor.TopLeft, containerWidget, true, 0, friendlycolour, 1, mod.UIBgFill.Solid, mod.GetTeam(1));
    ...
    mod.AddUIContainer("progress2", mod.CreateVector(150, 0, 0), mod.CreateVector(200, 20, 0), mod.UIAnchor.TopLeft, containerWidget, true, 0, enemycolour, 1, mod.UIBgFill.Solid, mod.GetTeam(2));
    ...
    mod.AddUIText("percentage1", mod.CreateVector(0, -5, 0), mod.CreateVector(100, 30, 0), mod.UIAnchor.TopLeft, containerWidget, true, 0, friendlybgcolour, 0.9, mod.UIBgFill.Solid, mod.Message(mod.stringkeys.payload.state.percentage, 35), 26, mod.CreateVector(1, 1, 1), 1, mod.UIAnchor.Center, mod.GetTeam(1));
    mod.AddUIText("percentage2", mod.CreateVector(0, -5, 0), mod.CreateVector(100, 30, 0), mod.UIAnchor.TopLeft, containerWidget, true, 0, enemybgcolour, 0.9, mod.UIBgFill.Solid, mod.Message(mod.stringkeys.payload.state.percentage, 35), 26, mod.CreateVector(1, 1, 1), 1, mod.UIAnchor.Center, mod.GetTeam(2));
}
